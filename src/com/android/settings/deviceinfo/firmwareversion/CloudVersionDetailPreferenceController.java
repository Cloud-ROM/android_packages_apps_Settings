...
public class CloudVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "CloudVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_CLOUD_VERSION_PROP = "org.cloud.version.display";
    ...
    public CloudVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_CLOUD_VERSION_PROP,
